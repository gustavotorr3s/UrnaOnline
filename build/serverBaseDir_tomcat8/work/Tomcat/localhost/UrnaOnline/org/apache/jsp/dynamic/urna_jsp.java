 ...
 * Generated at: 2019-06-28 22:42:29 UTC
...
if (usuario.getFk_nivel().getNivel() == 3) {
 ...
 if (usuario.isVotado() == false) {
      ...
      out.write("\t\t\t\t\t\t<form action=\"buscaCandidato\" method=\"get\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"lbCandidato\">Candidato: </label>\r\n");
      out.write("\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"lbPartido\">Partido: </label>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" placeholder=\"Número do seu Candidato...\" id=\"inputCandidato\" name=\"numero\" required maxlength=\"2\" [0-]>\r\n");
      out.write("\t\t\t\t\t\t\t");
