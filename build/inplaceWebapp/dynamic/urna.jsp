  ...
  <head>        
	...
	<body>
		...
		<% if (usuario.isHabilitado() == true) {%>
			<% if (usuario.isVotado() == false) {%>
				<div class="section">
					<div class="text-center" id="container-candidato">
						<form action="buscaCandidato" method="get">
							<label for="lbCandidato">Candidato: </label>
							<br>
							<label for="lbPartido">Partido: </label>
							<input type="text" class="form-control" placeholder="Número do seu Candidato..." id="inputCandidato" name="numero" required maxlength="2" [0-]>
							<% 
			...
			<% } else {
				out.print("<div align="+"center"+"> <h2> Você já votou, volte na próxima eleição ou no próximo turno ! </h2> </div>"); 
			}
			%>
		<%} else {
			out.print("<div align="+"center"+"> <h2> Você não está habilitado para votar, aguarde! </h2> </div>"); 
		}
		%>
	</body>
</html>