		...
		<div class="section">
			<div class="text-center" id="container-candidato">
				<form action="computarVoto" method="post">
					...
					<input type="text" class="form-control" placeholder="Número do seu Candidato..." id="inputCandidato" name="numero" value="<%= candidato.getNumero()%>" required disabled maxlength="2" [0-]>
					<div class="row">
						<div class="col-sm">
